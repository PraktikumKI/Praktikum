...
class Minesweeper:
    ...
    # Diese neue Gameloop Methode wurde mit Konsolenausgaben erweitert, welche die Schritte des Agenten und den Zustand
    # des Spieles visualisieren. Dazu wird immer das aktuelle Spielfeld und der gewählte Zug ausgegeben. Zusätzlich
    # wird im Falle eines Spielabschlusses das Minenfeld mit allen Minen aufgezeigt. Damit die Konsolenausgaben auch
    # in Ruhe betrachtet werden können, wurden an verschiedenen Stellen sleep Funktionen hinzugefügt, da der Algorithmus
    # sonst zu schnell spielen würde.
