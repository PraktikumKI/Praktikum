...
class Minesweeper:
    ...
    # Bei der gameloop Methode handelt es sich um eine Endlosschleife, welche die Anweisungen des Spielers entgegen
    # nimmt und dann die move Methode ausführt. Zusätzlich ist diese Methode auch noch dafür da, um den User über den
    # aktuellen Spielstatus zu informieren und einen Neustart zu ermöglichen.
    def gameloop(self):
        while True:
            self.printNumbers()
